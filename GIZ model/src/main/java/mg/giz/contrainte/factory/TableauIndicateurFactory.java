...
import mg.giz.data.dto.TableauIndicateurDto;

public class TableauIndicateurFactory {

	static ObjectMapper mapper = new ObjectMapper();

	public static TableauIndicateurDto getInstance(String str) {
		TableauIndicateurDto ind = new TableauIndicateurDto();
		try {
			...
			Double nbrBenef = Double.parseDouble(array[8] + "");
	...
	public static List<TableauIndicateurDto> getInstances(List<String> strs) {
		List<TableauIndicateurDto> result = new ArrayList<>();
		for (String str : strs) {
