...
@Controller
public class Crud233Controller {
	...
	@RequestMapping("/list_233")
	public String liste(Model model) {
		Long theme_id = themeService.selectThm("2.3.3");
		...
		return "crud-form/Form_list_233";
	}
	@RequestMapping("/add233")
	public String addFormateurFbsForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_233";
	}
	@RequestMapping("/save233")
	public String save233(@RequestParam("code_fkt") String code_fkt,
		...
		if (duplicated == true) {
			...
			return "redirect:/add233";
		}

		return "redirect:/list_233";
		
	}
	
	@RequestMapping("/edit233/{id}")
	public ModelAndView editFormateurFbs(@PathVariable(name = "id") Long id,
			Model model) throws ParseException {
		ModelAndView mav = new ModelAndView("crud-form/Form_modif_233");
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
	...
	@RequestMapping(value = "/saveModification233", method = RequestMethod.POST)
