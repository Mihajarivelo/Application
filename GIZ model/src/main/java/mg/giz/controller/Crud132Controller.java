...
@Controller
public class Crud132Controller {
	...
	@RequestMapping("/liste132")
	public String listSuccess(Model model) {
		int typepersonne = typepersonneService.findIdTypePersonne("ASA opérationnels");
		...
		return "crud-form/Form_list_132";
	}	
	
	@RequestMapping("/delete132/{id}")
	public String deleteHistoriqueAsaOperationnels(@PathVariable(name = "id") Long id) {
		historiqueRepository.deleteById(id);
		return "redirect:/liste132";
	}
	
	@RequestMapping("/add132")
	public String addHistoriqueAsaOperationnels(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_132";
	}
	
	@RequestMapping("/save132")
	public String saveHistoriqueAsaOperationnels(@RequestParam("personne_nom") String personne_nom,
	...
	@RequestMapping("/edit132/{id}/{personne_id}/{typepersonne_id}")
	public ModelAndView editHitoriqueAsaOperationnels(@PathVariable(name = "id") Long id,
			@PathVariable(name = "personne_id") Long personne_id,
			@PathVariable(name = "typepersonne_id") int typepersonne_id,
			Model model) throws ParseException {
		ModelAndView mav = new ModelAndView("crud-form/Form_modif_132");
	...
	@RequestMapping(value = "/saveEdit132", method = RequestMethod.POST)
	public String HistoriqueAsaOperationnels(@RequestParam("personne_nom") String personne_nom,
			@RequestParam("personne_genre") String personne_genre,
			@RequestParam("personne_anneenaiss") Long personne_anneenaiss,
			@RequestParam("personne_lieunaiss") String personne_lieunaiss, 
			@RequestParam("personne_cin") String personne_cin,
