...
@Controller
public class Crud325Controller {
	...
	@RequestMapping("/list_325")
	public String liste(Model model) {
		Long id = themeService.selectThm("3.2.5");
		...
		return "crud-form/Form_list_325";
	}
	@RequestMapping("/add325")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_325";
	}
	@RequestMapping("/save325")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("3.2.5");
		...
		Personne personneCreated = personneService.createPersonCrud323(personne, personne_nom, personne_genre, personne_lieunaiss, personne_anneenaiss, personne_contact, code_fkt);
		boolean duplicated = personneService.saveCrudPersonne(personneCreated);
		if (duplicated == true) {
			redirectAttributes.addFlashAttribute("duplicated", 1);
			return "redirect:/add325";
		}
	...
	@RequestMapping(value = "/saveModification325", method = RequestMethod.POST)
	public String saveModification125(@RequestParam("code_fkt") String code_fkt,
		...
		Personne personnerCreated = personneService.createPersonCrud323(personne, personne_nom, personne_genre, personne_lieunaiss, personne_anneenaiss, personne_contact, code_fkt);
