...
@Controller
public class Crud323Controller {
	...
	@RequestMapping("/list_323")
	public String liste(Model model) {
		Long id = themeService.selectThm("3.2.3");
		...
		return "crud-form/Form_list_323";
	}
	@RequestMapping("/add323")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_323";
	}
	@RequestMapping("/save323")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("3.2.3");
	...
	@RequestMapping(value = "/saveModification323", method = RequestMethod.POST)
