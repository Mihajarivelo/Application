...
@Controller
public class Crud126cController {
	...
	@RequestMapping("/list_126c")
	public String liste(Model model) {
		Long id = themeService.selectThm("1.2.6c");
		...
		return "crud-form/Form_list_126c";
	}
	@RequestMapping("/add126c")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_126c";
	}
	@RequestMapping("/save126c")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("1.2.6c");
	...
	@RequestMapping(value = "/saveModification126c", method = RequestMethod.POST)
