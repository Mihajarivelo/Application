...
@Controller
public class Crud126aController {
	...
	@RequestMapping("/list_126a")
	public String liste(Model model) {
		Long id = themeService.selectThm("1.2.6a");
		...
		return "crud-form/Form_list_126a";
	}
	@RequestMapping("/add126a")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_126a";
	}
	@RequestMapping("/save126a")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("1.2.6a");
	...
	@RequestMapping(value = "/saveModification126a", method = RequestMethod.POST)
