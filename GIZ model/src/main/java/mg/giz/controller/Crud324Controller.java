...
@Controller
public class Crud324Controller {
	...
	@RequestMapping("/list_324")
	public String liste(Model model) {
		Long theme_id = themeService.selectThm("3.2.4");
		...
		return "crud-form/Form_list_324";
	}
	@RequestMapping("/add324")
	public String addFormateurFbsForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_324";
	}
	@RequestMapping("/save324")
	public String save324(@RequestParam("code_fkt") String code_fkt,
		...
		if (duplicated == true) {
			...
			return "redirect:/add324";
		}

		return "redirect:/list_324";
		
	}
	
	@RequestMapping("/edit324/{id}")
	public ModelAndView editFormateurFbs(@PathVariable(name = "id") Long id,
			Model model) throws ParseException {
		ModelAndView mav = new ModelAndView("crud-form/Form_modif_324");
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
	...
	@RequestMapping(value = "/saveModification324", method = RequestMethod.POST)
