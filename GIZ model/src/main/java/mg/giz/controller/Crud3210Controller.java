...
@Controller
public class Crud3210Controller {
	...
	@RequestMapping("/list_3210")
	public String liste(Model model) {
		Long id = themeService.selectThm("3.2.10");
		...
		return "crud-form/Form_list_3210";
	}
	@RequestMapping("/add3210")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_3210";
	}
	@RequestMapping("/save3210")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("3.2.10");
		...
		Beneficierpgm beneficierpgmCreated = beneficierPgmService.createBeneficierpgm3210Crud(beneficierpgm, beneficierpgm_valeur, beneficierpgm_date, selectpersonne, theme_id);
	...
	@RequestMapping(value = "/saveModification3210", method = RequestMethod.POST)
	public String saveModification125(@RequestParam("code_fkt") String code_fkt,
		...
		Beneficierpgm beneficierpgmCreated = beneficierPgmService.createBeneficierpgm3210Crud(beneficierpgm, beneficierpgm_valeur, beneficierpgm_date, personne_id, theme_id);
		beneficierpgmRepository.save(beneficierpgmCreated);
		
		Personne personnerCreated = personneService.createPersonnCrud128(personne, personne_nom, personne_genre, personne_anneenaiss, code_fkt);
