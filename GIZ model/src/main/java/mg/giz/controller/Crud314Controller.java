...
@Controller
public class Crud314Controller {
	...
	@RequestMapping("/list_314")
	public String liste(Model model) {
		List <Beneficierpgm> Beneficierpgm = beneficierPgmService.List311("VSLA CONSTITUE");
		String[][] scList = ListeSouscomposante.souscomposante();
		model.addAttribute("scList", scList);
		model.addAttribute("Beneficierpgm", Beneficierpgm);
		return "crud-form/Form_list_314";
	}
	@RequestMapping("/add314")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_314";
	}
	@RequestMapping("/save314")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		String theme_programme = "VSLA CONSTITUE";
		...
		if (duplicatedBen == true) {
			...
			return "redirect:/add314";
		}
		return "redirect:/list_314";	
	}
	
	@RequestMapping("/delete314/{id}")
	public String deleteSensibilise(@PathVariable(name = "id") Long id) {
		beneficierPgmService.deleteBeneficier(id);
		return "redirect:/list_314";
	}
	
	@RequestMapping("/edit314/{theme_id}/{personne_id}")
	public ModelAndView editFormateurFbs(@PathVariable(name = "theme_id") Long theme_id,
		...
		ModelAndView mav = new ModelAndView("crud-form/Form_modif_314");
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
	...
	@RequestMapping(value = "/saveModification314", method = RequestMethod.POST)
