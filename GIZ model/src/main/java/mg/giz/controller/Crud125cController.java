...
@Controller
public class Crud125cController {
	...
	@RequestMapping("/list_125c")
	public String liste(Model model) {
		Long id = themeService.selectThm("1.2.5c");
		...
		return "crud-form/Form_list_125c";
	}
	@RequestMapping("/add125c")
	public String add125c(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_125c";
	}
	@RequestMapping("/save125c")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("1.2.5c");
	...
	@RequestMapping(value = "/saveModification125c", method = RequestMethod.POST)
