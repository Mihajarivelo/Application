...
@Controller
public class Crud326Controller {
	...
	@RequestMapping("/list_326")
	public String liste(Model model) {
		Long id = themeService.selectThm("3.2.6");
		...
		return "crud-form/Form_list_326";
	}
	@RequestMapping("/add326")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_326";
	}
	@RequestMapping("/save326")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("3.2.6");
	...
	@RequestMapping(value = "/saveModification326", method = RequestMethod.POST)
