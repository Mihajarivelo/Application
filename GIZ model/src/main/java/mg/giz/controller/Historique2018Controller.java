...
import mg.giz.service.metier.Historique2018QueryService;

@Controller
public class Historique2018Controller {

	@Autowired
	private Historique2018QueryService historique2018QueryService;

	@RequestMapping(value = "/indicateur-2018")
	public String getTableauIndicateurData(Model model) {
		...
		model.addAttribute("listRevenuExploitation",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getRevenuExploitationData()));
		...
		model.addAttribute("listRevenuType1Exploitation", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getRevenuType1ExploitationData()));
		...
		model.addAttribute("listRevenuType2Exploitation", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getRevenuType2ExploitationData()));
		...
		model.addAttribute("listRevenuType3Exploitation", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getRevenuType3ExploitationData()));
		...
		model.addAttribute("listTauxDiversificationRevenusType1", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType1Data()));
		...
		model.addAttribute("listTauxDiversificationRevenusType1Agricole", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType1AgricoleData()));
		...
		model.addAttribute("listTauxDiversificationRevenusType1NonAgricole", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType1NonAgricoleData()));
		...
		model.addAttribute("listTauxDiversificationRevenusType2", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType2Data()));
		...
		model.addAttribute("listTauxDiversificationRevenusType2Agricole", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType2AgricoleData()));
		...
		model.addAttribute("listTauxDiversificationRevenusType2NonAgricole", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType2NonAgricoleData()));
		...
		model.addAttribute("listTauxDiversificationRevenusType3", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType3Data()));
		...
		model.addAttribute("listTauxDiversificationRevenusType3Agricole", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType3AgricoleData()));
		...
		model.addAttribute("listTauxDiversificationRevenusType3NonAgricole", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxDiversificationRevenusType3NonAgricoleData()));

		// # de mois de soudure alimentaire/difficulté économique Type 1
		model.addAttribute("listMoisSoudureType1",
				HistoriqueIndicateurSaisirFactory.getInstances(historique2018QueryService.getMoisSoudureType1Data()));

		// # de mois de soudure alimentaire/difficulté économique Type 2
		model.addAttribute("listMoisSoudureType2",
				HistoriqueIndicateurSaisirFactory.getInstances(historique2018QueryService.getMoisSoudureType2Data()));

		// # de mois de soudure alimentaire/difficulté économique Type 3
		model.addAttribute("listMoisSoudureType3",
				HistoriqueIndicateurSaisirFactory.getInstances(historique2018QueryService.getMoisSoudureType3Data()));

		// # de FR suivis
		model.addAttribute("listFRSuivi",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getFRSuiviData()));

		// # de restitution auprès des FR
		model.addAttribute("listRestitutionFR",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getRestitutionFRData()));

		// # de formateurs FBS formés
		model.addAttribute("listFormateursFBSFormes",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getFormateursFBSFormesData()));

		// # de producteurs sensibilisés
		model.addAttribute("listProducteursSensibilises",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getProducteursSensibilisesData()));

		// # de session de formation FBS effectués
		model.addAttribute("listSessionFormationFBS",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getSessionFormationFBSData()));

		// # de producteurs formés (ayant terminé les 11 modules)
		model.addAttribute("listProducteursFormes",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getProducteursFormesData()));

		// Taux de completion de producteurs formés
		model.addAttribute("listTauxCompletion",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getTauxCompletionData()));
		...
		model.addAttribute("listBeneficiantPostFormationFBS", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getBeneficiantPostFormationFBSData()));

		// # d'entrepreneurs identifiés
		model.addAttribute("listEntrepreneursIdentifies",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getEntrepreneursIdentifiesData()));
		...
		model.addAttribute("listPersonnesRessourcesOperationnelles", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getPersonnesRessourcesOperationnellesData()));
		...
		model.addAttribute("listParticipantsPersonnesRessources", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getParticipantsPersonnesRessourcesData()));
		...
		model.addAttribute("listPepinieristesFonctionnels", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getPepinieristesFonctionnelsData()));

		// # d'ASA formés
		model.addAttribute("listASAFormes",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getASAFormesData()));

		// # d'ASA opérationnels
		model.addAttribute("listASAOperationnels",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getASAOperationnelsData()));

		// Chiffre d'affaire mensuel moyen des ASA
		model.addAttribute("listChiffreAffaireASA",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getChiffreAffaireASAData()));
		...
		model.addAttribute("listBeneficiairesServiceSanteAnimale", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getBeneficiairesServiceSanteAnimaleData()));

		// # de cheptels vaccinés
		model.addAttribute("listCheptelsVaccines",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getCheptelsVaccinesData()));
		...
		model.addAttribute("listFormateursElevagesOperationnels", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getFormateursElevagesOperationnelsData()));
		...
		model.addAttribute("listProducteursFormesBonnesPratiquesElevage", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getProducteursFormesBonnesPratiquesElevageData()));
		...
		model.addAttribute("listProducteursAdopte",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getProducteursAdopteData()));

		// # de fermes de diffusion opérationnelles
		model.addAttribute("listFermesDiffusionOperationnelles", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getFermesDiffusionOperationnellesData()));

		// # de visiteurs des fermes de diffusion
		model.addAttribute("listVisiteursFermesDiffusion",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getVisiteursFermesDiffusionData()));
		...
		model.addAttribute("listStructureProducteursFonctionnels", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getStructureProducteursFonctionnelsData()));
		...
		model.addAttribute("listStructureProducteursService", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getStructureProducteursServiceData()));
		...
		model.addAttribute("listPetitsProducteursFormes",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getPetitsProducteursFormesData()));

		// # de leader de coopératives coachés
		model.addAttribute("listLeaderCooperativesCoaches", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getLeaderCooperativesCoachesData()));

		// # de leader de coopératives formés
		model.addAttribute("listLeaderCooperativesFormes",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getLeaderCooperativesFormesData()));
		...
		model.addAttribute("listPersonnesPlateformesDialogue", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getPersonnesPlateformesDialogueData()));
		...
		model.addAttribute("listResolutionsDialoguesCommunautaires", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getResolutionsDialoguesCommunautairesData()));

		// # de MFR opérationnels
		model.addAttribute("listMFROperationnels",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getMFROperationnelsData()));

		// Un réseau de MFR opérationnel
		model.addAttribute("listReseauMFROperationnels",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getReseauMFROperationnelsData()));

		// # d'élèves étudiant dans les MFR
		model.addAttribute("listElevesEtudiantMFR",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getElevesEtudiantMFRData()));

		// # de jeunes diplômés sortant des MFR
		model.addAttribute("listJeunesdiplomessortantMFR",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getJeunesdiplomessortantMFRData()));

		// # de jeunes sortants des MFR mettant en œuvre leur projet
		model.addAttribute("listJeunesSortantsProjet",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getJeunesSortantsProjetData()));

		// # d'élèves formés sur FBS à travers les MFR
		model.addAttribute("listElevesformesFBSMFR",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getElevesformesFBSMFRData()));

		// # nombre d'échanges MFR entre Comité des jeunes
		model.addAttribute("listEchangesMFRComiteJeunes",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getEchangesMFRComiteJeunesData()));

		// # d'école bénéficiant des subventions
		model.addAttribute("listEcoleBeneficiantSubventions", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getEcoleBeneficiantSubventionsData()));

		// % des FRAM qui utilisent effectivement les subventions
		model.addAttribute("listFRAMUtilisentSubventions",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getFRAMUtilisentSubventionsData()));
		...
		model.addAttribute("listProportionsSubventions1", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getProportionsSubventions1Data()));
		...
		model.addAttribute("listProportionsSubventions2", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getProportionsSubventions2Data()));
		...
		model.addAttribute("listProportionsSubventions3", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getProportionsSubventions3Data()));

		// # d'élèves présents dans les écoles aidées
		model.addAttribute("listElevesPresentsEcoles",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getElevesPresentsEcolesData()));

		// # d'enseignants formés à l'éducation environnementale
		model.addAttribute("listEnseignantsFormes",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getEnseignantsFormesData()));

		// # d'enseignants kit mad'ère
		model.addAttribute("listEnseignantsKitMadere",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getEnseignantsKitMadereData()));

		// # d'école concernées
		model.addAttribute("listEcoleConcernees",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getEcoleConcerneesData()));

		// # de participants au concours environnemental
		model.addAttribute("listParticipantsConcours",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getParticipantsConcoursData()));

		// Pourcentage de participant ayant obtenu la moyenne au concours
		// environnemental
		model.addAttribute("listPourcentageParticipant",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getPourcentageParticipantData()));

		// # de producteurs couverts par la mutuelle de santé mahavelona
		model.addAttribute("listMahavelonaM12Adherants",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getMahavelonaM12AdherantsData()));

		// # de villages couverts par Mahavelona
		model.addAttribute("listVillagesCouvertsMahavelona", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getVillagesCouvertsMahavelonaData()));

		// Prévalence des maladies diarhéiques des membres de Mahavelona
		model.addAttribute("listPrevalenceMaladies",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getPrevalenceMaladiesData()));

		// Taux de sinistralité au niveau des zones d'intervention M7
		model.addAttribute("listTauxSinistraliteM7",
				HistoriqueIndicateurSaisirFactory.getInstances(historique2018QueryService.getTauxSinistraliteM7Data()));
		...
		model.addAttribute("listTauxSinistraliteM12", HistoriqueIndicateurSaisirFactory
				.getInstances(historique2018QueryService.getTauxSinistraliteM12Data()));

		// Taux de fréquentation des centres de santé pour les enfants des ménages
		// pauvres
		model.addAttribute("listTauxFrequentation1",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getTauxFrequentation1Data()));

		// Taux de fréquentation des structures de santé
		model.addAttribute("listTauxFrequentation2",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getTauxFrequentation2Data()));

		// Taux de satisfaction des membres de Mahavelona
		model.addAttribute("listTauxSatisfaction",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getTauxSatisfactionData()));

		// # de village ayant amélioré l'accès à l'eau potable
		model.addAttribute("listVillageAmeliore",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getVillageAmelioreData()));

		// # de ménages les plus vulnérables bénéficiant de grants
		model.addAttribute("listBeneficiantGrants",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getBeneficiantGrantsData()));

		// Subventions allouées aux ménages les plus vulnérables
		model.addAttribute("listSubventionsMenages",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getSubventionsMenagesData()));

		// # ménage qui rapportent que l'utilisation des grants
		model.addAttribute("listMenageRapportentGrants",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getMenageRapportentGrantsData()));

		// # de VSLA constitués
		model.addAttribute("listVSLAConstitues",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getVSLAConstituesData()));

		// # de personnes ayant accès aux services financiers informels via les VSLA
		model.addAttribute("listPersonnesFinanciersVSLA",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getPersonnesFinanciersVSLAData()));
		...
		model.addAttribute("listMontantInvestisGroupeVSLA", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getMontantInvestisGroupeVSLAData()));

		// # de VSLA fonctionnels
		model.addAttribute("listVSLAFonctionnels",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getVSLAFonctionnelsData()));

		// Mahavelona (lilghtpackage) => M7 Adhérant
		model.addAttribute("listMahavelonaM7Adherant",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getMahavelonaM7AdherantData()));
		...
		model.addAttribute("listJeunesParticipantAlphabetisation", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getJeunesParticipantAlphabetisationData()));

		// # de jeunes déscolarisés ayant complèté le programme d'alphabétisation
		model.addAttribute("listJeunesDescolarises",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getJeunesDescolarisesData()));

		// # de jeunes ayant complèté le programme d'alphabétisation
		model.addAttribute("listJeunesAyantComplete",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getJeunesAyantCompleteData()));

		// # de jeunes formés en plan de vie viable (pathway)
		model.addAttribute("listPathway",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getPathwayData()));

		// # de jeunes ayant un plan de vie viable, à préciser par type de plan de vie
		model.addAttribute("listJeunesTypePlanVie",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getJeunesTypePlanVieData()));

		// # de jeunes ayant obtenu des grants
		model.addAttribute("listJeunesAyantObtenuGrants",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getJeunesAyantObtenuGrantsData()));

		// Taux d'abandon scolaire des jeunes
		model.addAttribute("listTauxAbandonScolaire",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getTauxAbandonScolaireData()));

		// # des ménages sensibilisés
		model.addAttribute("listMenagesSensibilises",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getMenagesSensibilisesData()));
		...
		model.addAttribute("listTauxDiversificationMenagespauvres", HistoriqueIndicateurFactory
				.getInstances(historique2018QueryService.getTauxDiversificationMenagespauvresData()));

		// Taux de fréquentation des centres de santé pour les enfants des ménages
		// pauvres
		model.addAttribute("listTauxFrequentationEnfants",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getTauxFrequentationEnfantsData()));

		// Au moins 3 recommandations de santé
		model.addAttribute("listRecommandationsSante",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getRecommandationsSanteData()));

		// # d'atelier du secteur auquel participe le projet
		model.addAttribute("listAtelierSecteur",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getAtelierSecteurData()));

		// # de participation de SAVE THE CHILDREN aux réunions de SVI
		model.addAttribute("listParticipationReunionsSVI",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getParticipationReunionsSVIData()));

		// Taux de connaissance des droits des enfants dans les ménages et communautés
		model.addAttribute("listTauxConnaissance",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getTauxConnaissanceData()));

		// # d'acteur de la filière
		model.addAttribute("listActeurFiliere",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getActeurFiliereData()));

		// Etude d'Impact complète et partagee avec Unilever/Symrise
		model.addAttribute("listEtudeImpactComplete",
				HistoriqueIndicateurFactory.getInstances(historique2018QueryService.getEtudeImpactCompleteData()));

		return "giz-indicateur/indicateurs2018.html";
	}
}
