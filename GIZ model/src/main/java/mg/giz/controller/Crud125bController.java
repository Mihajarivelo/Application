...
@Controller
public class Crud125bController {
	...
	@RequestMapping("/list_125b")
	public String liste(Model model) {
		Long id = themeService.selectThm("1.2.5b");
		...
		return "crud-form/Form_list_125b";
	}
	@RequestMapping("/add125b")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_125b";
	}
	
	@RequestMapping("/save125b")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("1.2.5b");
	...
	@RequestMapping(value = "/saveModification125b", method = RequestMethod.POST)
