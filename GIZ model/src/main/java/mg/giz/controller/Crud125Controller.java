...
@Controller
public class Crud125Controller {
	...
	@RequestMapping("/list_125")
	public String liste(Model model) {
		Long id = themeService.select125();
		...
		return "crud-form/Form_list_125";
	}
	
	@RequestMapping("/add125")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_125";
	}
	
	@RequestMapping("/save125")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.select125();
	...
	@RequestMapping(value = "/saveModification125", method = RequestMethod.POST)
