...
@Controller
public class Crud311Controller {
	...
	@RequestMapping("/list_311")
	public String liste(Model model) {
		Long id = themeService.selectThm("3.1.1");
		...
		return "crud-form/Form_list_311";
	}
	
	@RequestMapping("/add311")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_311";
	}
	
	@RequestMapping("/save311")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("3.1.1");
		...
		return "redirect:/list_311";	
	}
	@RequestMapping("/delete311/{id}")
	public String delete311(@PathVariable(name = "id") Long id) {
		beneficierPgmService.deleteBeneficier(id);
		return "redirect:/list_311";
	}
	
	@RequestMapping("/edit311/{id}/{personne_id}")
	public ModelAndView editFormateurFbs(@PathVariable(name = "id") Long id,
			@PathVariable(name = "personne_id") Long personne_id,
			Model model) throws ParseException {
		ModelAndView mav = new ModelAndView("crud-form/Form_modif_311");
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
	...
	@RequestMapping(value = "/saveModification311", method = RequestMethod.POST)
	public String saveModification311(@RequestParam("code_fkt") String code_fkt,
