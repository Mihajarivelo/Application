...
@Controller
public class Crud214Controller {
	...
	@RequestMapping("/list_214")
	public String liste(Model model) {
		Long id = themeService.selectThm("2.1.4");
		...
		return "crud-form/Form_list_214";
	}
	@RequestMapping("/add214")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_214";
	}
	@RequestMapping("/save214")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("2.1.4");
		...
		if (duplicated == true) {
			...
			return "redirect:/add214";
		}
		Long selectpersonne = personneService.listPersonne(personne_nom);
		Beneficierpgm beneficierpgmCreated = beneficierPgmService.create214Crud(beneficierpgm, inscrismfr_anneesco,beneficierpgm_date, selectpersonne, theme_id);
	...
	@RequestMapping(value = "/saveModification214", method = RequestMethod.POST)
	public String saveModification125(@RequestParam("code_fkt") String code_fkt,
		...
		Beneficierpgm beneficierpgmCreated = beneficierPgmService.create214Crud(beneficierpgm, inscrismfr_anneesco, beneficierpgm_date, personne_id, theme_id);
