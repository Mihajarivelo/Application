...
@Controller
public class Crud134Controller {
	...
	@RequestMapping("/list_134")
	public String liste(Model model) {
		Long theme_id = themeService.selectThm("1.3.4");
		...
		return "crud-form/Form_list_134";
	}
	@RequestMapping("/add134")
	public String addFormateurFbsForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_134";
	}
	@RequestMapping("/save134")
	public String save134(@RequestParam("code_fkt") String code_fkt,
		...
		if (duplicated == true) {
			...
			return "redirect:/add134";
		}

		return "redirect:/list_134";
		
	}
	
	@RequestMapping("/edit134/{id}")
	public ModelAndView editFormateurFbs(@PathVariable(name = "id") Long id,
			Model model) throws ParseException {
		ModelAndView mav = new ModelAndView("crud-form/Form_modif_134");
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
	...
	@RequestMapping(value = "/saveModification134", method = RequestMethod.POST)
