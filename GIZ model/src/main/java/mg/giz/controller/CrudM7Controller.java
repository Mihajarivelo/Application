...
public class CrudM7Controller {
	...
	@RequestMapping("/list_M7")
	public String liste(Model model) {
		Long id = themeService.selectThm("3.1.8");
		...
		return "crud-form/Form_list_M7";
	}
	
	@RequestMapping("/addM7")
	public String addFormesForm(Model model) {
		List<Village> village = villageService.getAllVillage();
		model.addAttribute("village", village);
		return "crud-form/Form_add_M7";
	}
	@RequestMapping("/saveM7")
	public String saveSensibilise(@RequestParam("code_fkt") String code_fkt,
		...
		Long theme_id = themeService.selectThm("3.1.8");
	...
	@RequestMapping(value = "/saveModificationM7", method = RequestMethod.POST)
	public String saveModificationM7(@RequestParam("code_fkt") String code_fkt,
